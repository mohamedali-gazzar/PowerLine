                      ...
                      for (const g of order) {
                        ...
                        if (g) {
                          ...
                          rows.push(
                            <tr key={`g-${sec}-${g}`}>
                              <td className="py-1" />
                              <td colSpan={4} className="px-2 py-1 text-left font-display text-[11.5px] font-bold leading-[19px] underline underline-offset-2" style={{ color: TRED }}><span className="uppercase">{g}</span>, QTY ({gcq}) each contain:</td>
                            </tr>
                          );
                        }
