...
export async function transitionQtn(id: string, to: QtnStatus, note?: string, approverId?: string, replyToId?: string | null, comments?: string[], replies?: { text: string; replyToId: string | null }[]) {
  return api.qtns.transition(id, to, note, approverId, replyToId, comments, replies);
}
