...
export default function Announcements({ items = [] }: { items?: Announcement[] }) {
  ...
  return (
    <div style={S.card}>
      <div style={S.head}>
        <div style={S.title}><span style={S.spine} />Announcements</div>
...
const S: Record<string, React.CSSProperties> = {
  ...
  title: { display: "flex", alignItems: "center", gap: 9, fontSize: 16, fontWeight: 700 },
  spine: { width: 3, height: 17, background: C.orange, borderRadius: 2 },
