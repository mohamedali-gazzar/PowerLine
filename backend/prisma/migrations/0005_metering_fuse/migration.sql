...
INSERT INTO "new_RmuConfig" ("busbarCurrentA", "configCode", "fuseRatingA", "hasMetering", "id", "installation", "meteringCtPrimaryA", "nalCount", "nalfCount", "offerId", "productType", "rtuType", "voltageKv", "vtBurdenVa", "vtClass", "vtCores") SELECT "busbarCurrentA", "configCode", "fuseRatingA", "hasMetering", "id", "installation", "meteringCtPrimaryA", "nalCount", "nalfCount", "offerId", "productType", "rtuType", "voltageKv", "vtBurdenVa", "vtClass", "vtCores" FROM "RmuConfig";
